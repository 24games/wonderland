      ...
      <section className="min-h-screen w-full bg-gradient-to-b from-[#2a0e45] to-[#000000] pt-16 pb-10">
        ...
        <div className="flex justify-center mt-8 px-4">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-3 w-full max-w-md min-h-[70px] !py-6 rounded-full bg-[#25D366] px-6 text-lg font-bold text-white shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-[#25D366]/50 hover:bg-[#20BA5A] active:scale-95 sm:min-h-[80px] sm:!py-8 sm:text-xl"
          >
            <WhatsAppIcon />
            QUIERO ENTRAR AHORA
          </a>
