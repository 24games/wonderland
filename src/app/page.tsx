    ...
    <main className="w-full">
      ...
      <section className="relative h-[100dvh] w-full overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/${encodeURIComponent('background lp wonderland certo.webp')}')`,
          }}
        >
        ...
        <div className="absolute bottom-[185px] left-0 right-0 z-10 flex w-full items-center justify-center px-6">
          <a
            ...
            className="flex items-center justify-center w-[90%] max-w-md min-h-[80px] !py-6 rounded-full bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 px-6 text-2xl font-bold text-purple-900 shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-yellow-500/50 active:scale-95 animate-gentle-pulse sm:px-8 sm:min-h-[100px] sm:!py-8 sm:text-3xl"
          >
            QUIERO ENTRAR AHORA
          </a>
        </div>
