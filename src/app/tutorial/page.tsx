...
export default function TutorialPage() {
  useEffect(() => {
    ...
    script.src =
      "https://scripts.converteai.net/af053167-2542-4323-9c93-d010e7938eb5/players/6952abe0b73ccf90101d1c81/v4/player.js";
    script.async = true;
    ...
    return () => {
      ...
      const existingScript = document.querySelector(
        'script[src*="6952abe0b73ccf90101d1c81"]'
      );
      if (existingScript) {
        ...
        <div className="mb-10 w-full max-w-md">
          <div
            dangerouslySetInnerHTML={{
              __html: `<vturb-smartplayer id="vid-6952abe0b73ccf90101d1c81" style="display: block; margin: 0 auto; width: 100%; max-width: 400px;"></vturb-smartplayer>`,
            }}
          />
        </div>
